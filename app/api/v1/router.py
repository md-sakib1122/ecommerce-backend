...
Responsibilities:
  ...
  - Wire up lifespan events (startup / shutdown)
...
from app.core.supabase_client import init_supabase_client, close_supabase_client
from app.api.v1.router import api_router
from app.core.nltk import ensure_nltk_data
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    """
    # --- startup ---
    print("[startup] Initialising Supabase service-role client …")
